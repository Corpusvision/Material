    ...
    if (!empty($object) && !empty($subObject)) {
        if ($owner = $object->getActor()) {
            ...
            <div class="row idno-entry idno-entry-<?php
                ...
                <div
                    class="col-md-8 col-md-offset-2 <?= $subObject->getMicroformats2ObjectType() ?> idno-<?= $subObject->getContentTypeCategorySlug() ?> idno-object idno-content panel panel-default">
